...
static const char *style_names[] = { "Basic Screen", "Button Text", "Base Button", "Grid Button", "Square Icon Button", "Inline Icon", "Label in Icon Button", "Cell Voltage Container", "Heading", "Grid LED No Shadow" };
