...
void HAL_ADC_MspInit(ADC_HandleTypeDef *hadc) {
  ...
  if (hadc->Instance == ADC1) {
    ...
    PB1     ------> ADC1_INP5
    */
    GPIO_InitStruct.Pin = V_SENSE_5_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(V_SENSE_5_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = V_SENSE_12_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(V_SENSE_12_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef *hadc) {
  if (hadc->Instance == ADC1) {
    ...
    PB1     ------> ADC1_INP5
    */
    HAL_GPIO_DeInit(V_SENSE_5_GPIO_Port, V_SENSE_5_Pin);

    HAL_GPIO_DeInit(V_SENSE_12_GPIO_Port, V_SENSE_12_Pin);
...
void HAL_LTDC_MspDeInit(LTDC_HandleTypeDef *hltdc) {
  if (hltdc->Instance == LTDC) {
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOE, GPIO_PIN_11 | GPIO_PIN_12 | GPIO_PIN_13 |
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef *htim) {
  ...
  if (htim->Instance == TIM1) {
    ...
    PE9     ------> TIM1_CH1
    */
    GPIO_InitStruct.Pin = BKLT_CTRL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
    HAL_GPIO_Init(BKLT_CTRL_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspInit(UART_HandleTypeDef *huart) {
  ...
  if (huart->Instance == UART4) {
    ...
    PD1     ------> UART4_TX
    */
    GPIO_InitStruct.Pin = DPAD_RX_Pin | DPAD_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef *huart) {
  if (huart->Instance == UART4) {
    ...
    PD1     ------> UART4_TX
    */
    HAL_GPIO_DeInit(GPIOD, DPAD_RX_Pin | DPAD_TX_Pin);
